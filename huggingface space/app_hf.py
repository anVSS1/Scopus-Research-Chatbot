...
# Configuration - Files expected in HF Space root
...
def load_database_entities():
    ...
    if not os.path.exists(DATABASE_NAME):
        print(f"⚠️ Database file {DATABASE_NAME} not found")
...
def create_interface():
    with gr.Blocks(
        ...
        <div class="main-header">
            ...
            <h2>Intelligent Scientific Literature Search</h2>
            <p>Ask questions in natural language about scientific papers!</p>
        </div>
        """)
